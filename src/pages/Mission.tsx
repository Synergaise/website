      ...
      <section className="pt-32 pb-24 px-6 bg-background">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center space-y-8 animate-fade-in-up">
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-heading font-black leading-[1] tracking-tight text-foreground mb-0.05">
              Building intelligent systems
            </h1>
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-heading font-black leading-[1] tracking-tight text-foreground">
