      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mt-16 max-w-4xl mx-auto">
          <p className="text-base md:text-lg leading-relaxed text-foreground">
            At <span className="uppercase">SYNER<span className="tracking-tight">G<span className="italic">AI</span></span><span className="tracking-wider">SE</span></span>, we build custom-tailored solutions designed around your exact workflows and challenges.
            <br />
