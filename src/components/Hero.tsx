...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 bg-gradient-to-br from-background to-black">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-primary/10 rounded-full blur-[100px] animate-orbital-glow" style={{ animationDelay: "2s" }} />
      </div>
        ...
        <div className="max-w-5xl mx-auto text-center space-y-12 animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
            <Button
              ...
              variant="outline"
              size="lg"
              className="font-heading font-bold uppercase text-button tracking-[0.04em] px-8 border-primary text-primary hover:bg-primary hover:text-primary-foreground transition-all duration-300"
            >
              See Our Work
