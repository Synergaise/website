  ...
  return <section id='founders' className='bg-muted/30 py-24 px-6 flex flex-col items-center text-center rounded-[24px] max-w-7xl mx-auto my-16'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-16 items-center w-full max-w-5xl'>
        ...
        delay: 0.1
          ...
          <img src={judePhoto} alt='Jude Hill, Co-Founder of Synergaise' className='w-64 h-64 object-cover rounded-[16px] shadow-md mb-6' />
        ...
        delay: 0.2
          ...
          <div className='w-64 h-64 rounded-[16px] shadow-md mb-6 overflow-hidden'>
